...
/**
 * The ReCaptchaUnavailableException class extends the RuntimeException class.
 * This class represents a custom exception that is thrown when the reCAPTCHA service is unavailable.
 */
public final class ReCaptchaUnavailableException extends RuntimeException {
    ...
    /**
     * This is a parameterized constructor for the ReCaptchaUnavailableException class.
     * It initializes the superclass with the provided message and cause.
     *
    ...
    /**
     * This is a parameterized constructor for the ReCaptchaUnavailableException class.
     * It initializes the superclass with the provided cause.
     *
     * @param cause a Throwable that represents the cause of the exception
     */
