...
/**
 * The ReCaptchaInvalidException class extends the RuntimeException class.
 * This class represents a custom exception that is thrown when the reCAPTCHA validation fails.
 */
public final class ReCaptchaInvalidException extends RuntimeException {
    ...
    /**
     * This is a parameterized constructor for the ReCaptchaInvalidException class.
